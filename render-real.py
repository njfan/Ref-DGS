...
from gaussian_renderer import render, render_real, render_ref
import torchvision
...
if __name__ == "__main__":
    ...
    gaussExtractor = GaussianExtractor(gaussians, ref_gaussians, render_real, render_ref, pipe, bg_color=bg_color, ENV_CENTER=ENV_CENTER, ENV_RADIUS=ENV_RADIUS, XYZ=XYZ)    
